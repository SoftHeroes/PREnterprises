...
$mail->Username = "shubhamjobanputraco@gmail.com"; // Your Gmail address.
$mail->Password = "zP376>'7;TY/h}z2"; // Your Gmail login password or App Specific Password.

/*
 * Message Configuration
 */

$mail->setFrom('support@prenterpriseco.com', 'PR Enterprise'); // Set the sender of the message.
$mail->addAddress('mhe.soluation@gmail.com'); // Set the recipient of the message.
$mail->Subject = 'Inquiry query Arrive'; // The subject of the message.
